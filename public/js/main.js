{
  ...
  const sendNotificationForm = document.getElementById(
    'send-notification-form'
  );
//   const messaging = firebase.messaging();
  firebase.messaging().usePublicVapidKey("BPPNEWamSL4yvTZt07V7I_3BAK8qnDgAWdoj5r_7ukRi9reBBtSajGJdbMqqnk9MWKD52Z7RBvQYOgHP9f2IbEA");
